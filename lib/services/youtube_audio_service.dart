...
class YoutubeAudioService {
  ...
  static const Map<EmotionType, List<String>> _keywordPool = {
    ...
    EmotionType.shy: [
      '수줍은 감성 한국 발라드', '설레는 첫사랑 노래',
      '귀여운 케이팝 발라드', '부끄러운 감성 노래',
      '풋풋한 사랑 노래 한국', '수줍음 감성 케이팝',
      '달달한 사랑 노래 한국', '청순 감성 케이팝 2024',
    ],
    EmotionType.anxious: [
      '마음 안정되는 한국 음악', '불안할 때 듣는 힐링 노래',
      '긴장 풀리는 잔잔한 발라드', '걱정 날려주는 노래 한국',
      '마음이 편해지는 음악', '긴장 해소 한국 노래',
      '불안 해소 힐링 음악', '차분해지는 한국 발라드',
    ],
    EmotionType.moved: [
      '뭉클한 한국 발라드 명곡', '감동적인 노래 케이팝',
      '눈물 나는 감성 발라드', '마음 울리는 한국 노래',
      '가슴 찡한 노래 모음', '감동 케이팝 플레이리스트',
      '아름다운 한국 발라드', '벅차오르는 노래 한국',
    ],
    EmotionType.lonely: [
      '혼자일 때 듣는 노래 한국', '외로울 때 감성 발라드',
      '쓸쓸한 새벽 노래 한국', '혼자 듣는 감성 케이팝',
      '외로운 밤 노래 모음', '감성 새벽 한국 노래',
      '혼자 있는 시간 노래', '고독한 감성 발라드',
    ],
    EmotionType.bored: [
      '기분 전환 한국 노래', '활기찬 케이팝 추천 2024',
      '심심할 때 신나는 케이팝', '중독성 있는 한국 노래',
      '흥 올라오는 노래 한국', '재미있는 케이팝 모음',
      '업템포 한국 노래 추천', '씐나는 케이팝 히트',
    ],
    EmotionType.hopeful: [
      '희망적인 한국 노래', '응원 노래 케이팝 모음',
      '기분 좋아지는 한국 노래', '파이팅 넘치는 케이팝',
      '긍정 에너지 한국 노래', '꿈 향해 가는 노래',
      '용기 주는 한국 발라드', '희망 케이팝 플레이리스트',
    ],
  };
